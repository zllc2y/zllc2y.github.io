...
(function ($) {
    ...
    var XSwitch = (function () {
        ...
        function _scrollPage(_this) {
            ...
            // 自定义添加屏幕动画           
            if(_this.index==1){
                $('.junior').css('-webkit-animation','leftTop 1s 1');
                $('.junior').css('-moz-animation','leftTop 1s 1');
                $('.junior').css('-o-animation','leftTop 1s 1');
                $('.junior').css('-ms-animation','leftTop 1s 1');

                $('.senior').css('-webkit-animation','rightTop 1s 1');
                $('.senior').css('-moz-animation','rightTop 1s 1');
                $('.senior').css('-o-animation','rightTop 1s 1');
                $('.senior').css('-ms-animation','rightTop 1s 1');

                $('.college').css('-webkit-animation','leftBottom 1s 1');
                $('.college').css('-moz-animation','leftBottom 1s 1');
                $('.college').css('-o-animation','leftBottom 1s 1');
                $('.college').css('-ms-animation','leftBottom 1s 1');

                $('.lover').css('-webkit-animation','rightBottom 1s 1');
                $('.lover').css('-moz-animation','rightBottom 1s 1');
                $('.lover').css('-o-animation','rightBottom 1s 1');
                $('.lover').css('-ms-animation','rightBottom 1s 1');                
            }else{
                $('.junior').css('-webkit-animation','null');
                $('.junior').css('-moz-animation','null');
                $('.junior').css('-o-animation','null');
                $('.junior').css('-ms-animation','null');

                $('.senior').css('-webkit-animation','null');
                $('.senior').css('-moz-animation','null');
                $('.senior').css('-o-animation','null');
                $('.senior').css('-ms-animation','null');

                $('.college').css('-webkit-animation','null');
                $('.college').css('-moz-animation','null');
                $('.college').css('-o-animation','null');
                $('.college').css('-ms-animation','null');

                $('.lover').css('-webkit-animation','null');
                $('.lover').css('-moz-animation','null');
                $('.lover').css('-o-animation','null');
                $('.lover').css('-ms-animation','null');
            }
            // if(_this.index==4){
            //     $('.line-left-five').css('-webkit-animation','fadeLeft 2s 1');
            //     $('.line-left-five').css('-moz-animation','fadeLeft 2s 1');
            //     $('.line-left-five').css('-o-animation','fadeLeft 2s 1');
            //     $('.line-left-five').css('-ms-animation','fadeLeft 2s 1');

            //     $('.line-right-five').css('-webkit-animation','fadeRight 2s 1');
            //     $('.line-right-five').css('-moz-animation','fadeRight 2s 1');
            //     $('.line-right-five').css('-o-animation','fadeRight 2s 1');
            //     $('.line-right-five').css('-ms-animation','fadeRight 2s 1');
                
            // }else{
            //     $('.line-left-five').css('-webkit-animation','null');
            //     $('.line-left-five').css('-moz-animation','null');
            //     $('.line-left-five').css('-o-animation','null');
            //     $('.line-left-five').css('-ms-animation','null');

            //     $('.line-right-five').css('-webkit-animation','null');
            //     $('.line-right-five').css('-moz-animation','null');
            //     $('.line-right-five').css('-o-animation','null');
            //     $('.line-left-five').css('-ms-animation','null');
            // }
